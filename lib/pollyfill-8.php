...
namespace {
    ...
    if (!\function_exists('win32_get_service_env_vars')) {
        /**
         * Return all environment variables of a service.
         *
         * @param string $servicename name of the service to query
         *
         * @return array<string,string> Environment variables name as key and value as value
         *
         * @throws ValueError when $serviceName is empty string
         */
    ...
    if (!\function_exists('win32_add_service_env_var')) {
        function win32_add_service_env_var(string $servicename, string $varName, string $varValue): void
        {
        }
    }

    if (!\function_exists('win32_remove_service_env_var')) {
    ...
    if (!\function_exists('win32_read_right_access_service')) {
        function win32_read_right_access_service(
            string $servicename,
            string $username,
            string $machine = '',
        ): Win32Service\RightInfo {
            throw new Win32ServiceException('Internal extension error (ACL empty)', 16000);
        }
    }

    if (!\function_exists('win32_read_all_rights_access_service')) {
    ...
    if (!\function_exists('win32_add_right_access_service')) {
        function win32_add_right_access_service(
            string $servicename,
            string $username,
            int $right,
            string $machine = '',
    ...
    if (!\function_exists('win32_remove_right_access_service')) {
...
namespace Win32Service {
    if (!class_exists(RightInfo::class)) {
        final class RightInfo implements \Stringable
        {
