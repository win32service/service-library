...
\define('WIN32_INFO_STATUS_SERVICE_TYPE', 'ServiceType', true);
\define('WIN32_INFO_STATUS_CURRENT_STATE', 'CurrentState', true);
\define('WIN32_INFO_STATUS_CONTROLS_ACCEPTED', 'ControlsAccepted', true);
\define('WIN32_INFO_STATUS_WIN32_EXIT_CODE', 'Win32ExitCode', true);
\define('WIN32_INFO_STATUS_SERVICE_SPECIFIC_EXIT_CODE', 'ServiceSpecificExitCode', true);
\define('WIN32_INFO_STATUS_CHECK_POINT', 'CheckPoint', true);
\define('WIN32_INFO_STATUS_WAIT_HINT', 'WaitHint', true);
\define('WIN32_INFO_STATUS_PROCESS_ID', 'ProcessId', true);
\define('WIN32_INFO_STATUS_SERVICE_FLAGS', 'ServiceFlags', true);
